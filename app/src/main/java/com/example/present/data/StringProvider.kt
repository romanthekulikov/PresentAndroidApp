...
object StringProvider {
    ...
    const val COUNTER_SCHEMA = "MMмес:ddдней:hhчас:mmмин:ssс"
    ...
    val hintMap = mapOf(
        0 to "Парк в котором мы впервые катались на аттракционах:\n" +
                "1 - количество аттракцонов в парке\n" +
                "2 - стоимость аттракциона на котором мы прокатились первым делом",
        1 to "Вэйп-шоп в котором я покупал тебе картриджи",
        2 to "Скамейка, где ты съела пельмешку в форме сердца",
        3 to "Вечный огонь"
    )

    val additionalHintMap = mapOf(
        0 to "Всю информацию ты можешь легко найти на кассе^^",
        1 to "Код где-то между скамейкой и стенкой",
        2 to "Прямо перед скамейкой написан код",
